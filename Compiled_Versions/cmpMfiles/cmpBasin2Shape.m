function cmpBasin2Shape(wdir,MakeStreamsMat,location_of_data_files,varargin)
	% Description:
	...
	%		extra_field_values [] - name text file of extra field values you wish to include. The first column in this file must be the river basin number
	...
	parse(p,wdir,MakeStreamsMat,location_of_data_files,varargin{:});
	wdir=p.Results.wdir;
