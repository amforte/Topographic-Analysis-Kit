function SegmentPicker(DEM,FD,A,S,basin_num,varargin)
	...
	%	plot_style - expects either 'refresh' or 'keep', default is 'refresh' if no input is provided. If 'refresh' is given, the plots reset
	...
	%	SegmentPicker(DEM,FD,A,S,2,'direction','up','ref_concavity',0.6,'min_grad',0.00001);
	%	SegmentPicker(DEM,FD,A,S,32,'direction','down','ref_concavity',0.5,'min_elev',300,'recalc',true);
	%
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
